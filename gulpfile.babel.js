...
gulp.task('build', gulp.series(clean, pages, sass, images, fonts, inline))
...
function fonts() {
	return gulp
		.src(['src/assets/fonts/**/*', '!src/assets/fonts/archive/**/*'])
...
function watch() {
	...
	gulp.watch('src/assets/img/**/*').on(
		'all',
		gulp.series(images, fonts, browser.reload)
	)
}
...
function zip() {
	...
	var moveTasks = htmlFiles.map(function(file) {
		...
		return merge(moveHTML, moveImages, moveFonts)
